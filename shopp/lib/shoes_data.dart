...
Future<List<Shoes>> fetchShoes() async {
  String phpurl = "http://192.168.43.73/projetmobdev/shoes.php";

  
  //String phpurl = "http://192.168.1.10/projetmobdev/shoes.php";
  ...
  if (response.statusCode == 200) {
    ...
    return allAlbums.map<Shoes>((json) => Shoes.fromJson(json)).toList();
  }
  return [];
}
